...
#define MOTOR_LEFT_PWM_PIN TCPWM_CH05_P02_2
#define MOTOR_LEFT_DIR_PIN_P P07_2
#define MOTOR_LEFT_DIR_PIN_N P07_3
#define MOTOR_LEFT_ENCODER_TIMER TC_CH58_ENCODER
#define MOTOR_LEFT_ENCODER_PIN_A TC_CH07_ENCODER_CH1_P07_6
#define MOTOR_LEFT_ENCODER_PIN_B TC_CH07_ENCODER_CH2_P07_7

#define MOTOR_RIGHT_PWM_PIN TCPWM_CH04_P02_3
#define MOTOR_RIGHT_DIR_PIN_P P07_0
#define MOTOR_RIGHT_DIR_PIN_N P07_1
